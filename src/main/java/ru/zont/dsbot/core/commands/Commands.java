...
public class Commands {
    ...
    public static HashMap<String, CommandAdapter> getAllCommands(ZDSBot bot) {
        HashMap<String, CommandAdapter> res = new HashMap<>();
        for (CommandAdapter a: bot.commandAdapters)
    ...
    public static CommandAdapter forClass(Class<? extends CommandAdapter> klass, ZDSBot bot) {
        HashMap<String, CommandAdapter> comms = Commands.getAllCommands(bot);
        for (Map.Entry<String, CommandAdapter> entry: comms.entrySet())
    ...
    public static void call(Class<? extends CommandAdapter> klass, String inputRaw, MessageReceivedEvent event, ZDSBot bot) {
        CommandAdapter adapter = forClass(klass, bot);
        if (adapter != null) {
